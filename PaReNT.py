...
dirname = "e17-arc=Gabriel-clu=True-bat=64-epo=1000-uni=2048-att=128-cha=64-tes=0-tra=1-len=0.0-fra=1-lr=0.0001-opt=Adam-dro=0.2-rec=0.5-l=l1-use=1-neu=0-neu=0-sem=0"
