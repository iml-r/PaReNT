...
try:
    from scripts.PaReNT_utils import grapheme_encode, cyril_to_latin, latin_to_cyril, decide_word_origin, retrieval_accuracy, contains_empty_lst
    import scripts.derinet
except:
    from PaReNT_utils import grapheme_encode, cyril_to_latin, latin_to_cyril, decide_word_origin, retrieval_accuracy, contains_empty_lst
    import derinet
