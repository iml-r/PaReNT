...
parser.add_argument("--batch_size", default=64, type=int, help="Batch size of the model. Larger batch size is faster, but consumes more memory. Negligible effect when inferring on GPU")
